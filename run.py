...
parser.add_argument('--startpoint', type=float, default=0.8)
...
parser.add_argument('--sec_embed', type=bool, default=False)
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_{}_ft{}_sp{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_K{}_lr{}_ep{}_bs{}_{}_{}'.format(
        args.model_id,
        args.model,
        args.data,
        args.features,
